...
class ActiveField extends Component
{
    ...
    public function render($content = null)
    {
        if ($content === null) {
            if (!isset($this->parts['{input}'])) {
                $this->parts['{input}'] = Easyui::activeTextbox($this->model, $this->attribute, $this->inputOptions);
            }
    ...
    public function input($type, $options = [])
    {
        ...
        $this->parts['{input}'] = Easyui::activeInput($type, $this->model, $this->attribute, $options);
    ...
    public function textbox($options = [])
    {
        $options = array_merge($this->inputOptions, $options);
        $this->adjustLabelFor($options);
        $this->parts['{input}'] = Easyui::activeTextbox($this->model, $this->attribute, $options);
    ...
    public function password($options = [])
    {
        $options = array_merge($this->inputOptions, $options);
        $this->adjustLabelFor($options);
        $this->parts['{input}'] = Easyui::password($this->model, $this->attribute, $options);
